    ...
    return (
        <div className="flex-shrink-0 w-full flex items-center justify-center pt-0 min-h-0 overflow-hidden">
            <div className="text-center w-full relative z-20 px-2 md:px-4">
                <div className="font-header text-xl md:text-3xl text-white tracking-wide leading-none mb-1 select-none balatro-text-shadow-hard">
                    {title}
                </div>
                <div className="w-full max-w-xs md:max-w-sm mx-auto flex flex-col gap-0.5 md:gap-1">
                    <div className="flex justify-between items-center py-0.5 md:py-1 border-y border-white/10 text-[11px] md:text-[13px] font-pixel font-normal text-white/40 tracking-[0.05em] md:tracking-[0.1em]">
