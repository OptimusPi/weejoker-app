...
const PLAYING_CARD_PATTERNS: Record<string, Record<string, { x: number; y: number }>> = {
    "Hearts": {
        "Ace": { x: 0, y: 0 }, "2": { x: 1, y: 0 }, "3": { x: 2, y: 0 }, "4": { x: 3, y: 0 }, "5": { x: 4, y: 0 }, "6": { x: 5, y: 0 },
        "7": { x: 6, y: 0 }, "8": { x: 7, y: 0 }, "9": { x: 8, y: 0 }, "10": { x: 9, y: 0 }, "Jack": { x: 10, y: 0 },
        "Queen": { x: 11, y: 0 }, "King": { x: 12, y: 0 }
    },
    "Clubs": {
        "Ace": { x: 0, y: 1 }, "2": { x: 1, y: 1 }, "3": { x: 2, y: 1 }, "4": { x: 3, y: 1 }, "5": { x: 4, y: 1 }, "6": { x: 5, y: 1 },
        "7": { x: 6, y: 1 }, "8": { x: 7, y: 1 }, "9": { x: 8, y: 1 }, "10": { x: 9, y: 1 }, "Jack": { x: 10, y: 1 },
        "Queen": { x: 11, y: 1 }, "King": { x: 12, y: 1 }
    },
    "Diamonds": {
        "Ace": { x: 0, y: 2 }, "2": { x: 1, y: 2 }, "3": { x: 2, y: 2 }, "4": { x: 3, y: 2 }, "5": { x: 4, y: 2 }, "6": { x: 5, y: 2 },
        "7": { x: 6, y: 2 }, "8": { x: 7, y: 2 }, "9": { x: 8, y: 2 }, "10": { x: 9, y: 2 }, "Jack": { x: 10, y: 2 },
        "Queen": { x: 11, y: 2 }, "King": { x: 12, y: 2 }
    },
    "Spades": {
        "Ace": { x: 0, y: 3 }, "2": { x: 1, y: 3 }, "3": { x: 2, y: 3 }, "4": { x: 3, y: 3 }, "5": { x: 4, y: 3 }, "6": { x: 5, y: 3 },
        "7": { x: 6, y: 3 }, "8": { x: 7, y: 3 }, "9": { x: 8, y: 3 }, "10": { x: 9, y: 3 }, "Jack": { x: 10, y: 3 },
        "Queen": { x: 11, y: 3 }, "King": { x: 12, y: 3 }
    }
};
