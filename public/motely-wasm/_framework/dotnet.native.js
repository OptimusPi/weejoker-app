...
function ___syscall_fadvise64(fd, offset, len, advice) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(4, 0, 0, fd, offset, len, advice);
 return 0;
}
...
function ___syscall_statfs64(path, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(8, 0, 1, path, size, buf);
 try {
  path = SYSCALLS.getStr(path);
...
function ___syscall_fstatfs64(fd, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(7, 0, 1, fd, size, buf);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _emscripten_force_exit(status) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(21, 0, 1, status);
...
function _fd_pread(fd, iov, iovcnt, offset, pnum) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(26, 0, 1, fd, iov, iovcnt, offset, pnum);
 offset = bigintToI53Checked(offset);
 try {
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
DOTNET.setup({
 ...
 gitHash: "44525024595742ebe09023abe709df51de65009b"
});

var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_faccessat, ___syscall_fadvise64, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_fstatfs64, ___syscall_statfs64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_newfstatat, ___syscall_openat, ___syscall_readlinkat, ___syscall_stat64, ___syscall_unlinkat, __mmap_js, __munmap_js, _emscripten_force_exit, __emscripten_runtime_keepalive_clear, _environ_get, _environ_sizes_get, _fd_close, _fd_pread, _fd_pwrite, _fd_read, _fd_seek, _fd_sync, _fd_write ];
...
var _mono_aot_Motely_get_method = Module["_mono_aot_Motely_get_method"] = a0 => (_mono_aot_Motely_get_method = Module["_mono_aot_Motely_get_method"] = wasmExports["mono_aot_Motely_get_method"])(a0);

var _mono_aot_Motely_Orchestration_Browser_get_method = Module["_mono_aot_Motely_Orchestration_Browser_get_method"] = a0 => (_mono_aot_Motely_Orchestration_Browser_get_method = Module["_mono_aot_Motely_Orchestration_Browser_get_method"] = wasmExports["mono_aot_Motely_Orchestration_Browser_get_method"])(a0);

var _mono_aot_Motely_Orchestration_get_method = Module["_mono_aot_Motely_Orchestration_get_method"] = a0 => (_mono_aot_Motely_Orchestration_get_method = Module["_mono_aot_Motely_Orchestration_get_method"] = wasmExports["mono_aot_Motely_Orchestration_get_method"])(a0);

var _mono_aot_Motely_Repository_get_method = Module["_mono_aot_Motely_Repository_get_method"] = a0 => (_mono_aot_Motely_Repository_get_method = Module["_mono_aot_Motely_Repository_get_method"] = wasmExports["mono_aot_Motely_Repository_get_method"])(a0);

var _mono_aot_Motely_WASM_get_method = Module["_mono_aot_Motely_WASM_get_method"] = a0 => (_mono_aot_Motely_WASM_get_method = Module["_mono_aot_Motely_WASM_get_method"] = wasmExports["mono_aot_Motely_WASM_get_method"])(a0);
...
var _mono_aot_YamlDotNet_get_method = Module["_mono_aot_YamlDotNet_get_method"] = a0 => (_mono_aot_YamlDotNet_get_method = Module["_mono_aot_YamlDotNet_get_method"] = wasmExports["mono_aot_YamlDotNet_get_method"])(a0);
