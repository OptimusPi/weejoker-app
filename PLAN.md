...
- **Target**: 320px wide, two halves
  ...
  - **Right 50%**: Erratic deck back + stake sticker (rotated ~12°), stacked with Standardcard showing featured rank|suit from JAML
- **Rules**:
  - DeckSprite and Standardcard must be same visual size (size={40})
